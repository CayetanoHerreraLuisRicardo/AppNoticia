...
{
    public sealed partial class HipertextualDetail : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (HipertextualModel != null)
            {
                ...
                HipertextualModel.SelectItem(e.Parameter);

                HipertextualModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
