...
{
    public sealed partial class MicrosiervosDetail : Page
    {
        ...
        public MicrosiervosDetail()
        {
            this.InitializeComponent();
            _navigationHelper = new NavigationHelper(this);

            MicrosiervosModel = new MicrosiervosViewModel();
        }

        public MicrosiervosViewModel MicrosiervosModel { get; private set; }
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (MicrosiervosModel != null)
            {
                await MicrosiervosModel.LoadItemsAsync();
                MicrosiervosModel.SelectItem(e.Parameter);

                MicrosiervosModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
        ...
        private void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            if (MicrosiervosModel != null)
            {
                MicrosiervosModel.GetShareContent(args.Request);
            }
        }
