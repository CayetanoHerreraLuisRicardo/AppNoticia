...
{
    public sealed partial class CNNEspanolDetail : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (CNNEspanolModel != null)
            {
                ...
                CNNEspanolModel.SelectItem(e.Parameter);

                CNNEspanolModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
