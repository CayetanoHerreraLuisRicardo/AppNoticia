...
{
    public sealed partial class MilenioDetail : Page
    {
        ...
        public MilenioDetail()
        {
            this.InitializeComponent();
            _navigationHelper = new NavigationHelper(this);

            MilenioModel = new MilenioViewModel();
        }

        public MilenioViewModel MilenioModel { get; private set; }
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (MilenioModel != null)
            {
                await MilenioModel.LoadItemsAsync();
                MilenioModel.SelectItem(e.Parameter);

                MilenioModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
        ...
        private void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            if (MilenioModel != null)
            {
                MilenioModel.GetShareContent(args.Request);
            }
        }
