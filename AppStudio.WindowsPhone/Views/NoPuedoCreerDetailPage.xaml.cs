...
{
    public sealed partial class NoPuedoCreerDetail : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (NoPuedoCreerModel != null)
            {
                ...
                NoPuedoCreerModel.SelectItem(e.Parameter);

                NoPuedoCreerModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
