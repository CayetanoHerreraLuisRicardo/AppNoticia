...
{
    public sealed partial class SDPNoticiasDetail : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (SDPNoticiasModel != null)
            {
                await SDPNoticiasModel.LoadItemsAsync();
                SDPNoticiasModel.SelectItem(e.Parameter);

                SDPNoticiasModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
        ...
        private void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            if (SDPNoticiasModel != null)
            {
                SDPNoticiasModel.GetShareContent(args.Request);
            }
        }
