...
{
    public sealed partial class ReformaDetail : Page
    {
        ...
        public ReformaDetail()
        {
            this.InitializeComponent();
            _navigationHelper = new NavigationHelper(this);

            ReformaModel = new ReformaViewModel();
        }

        public ReformaViewModel ReformaModel { get; private set; }
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (ReformaModel != null)
            {
                await ReformaModel.LoadItemsAsync();
                ReformaModel.SelectItem(e.Parameter);

                ReformaModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
        ...
        private void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            if (ReformaModel != null)
            {
                ReformaModel.GetShareContent(args.Request);
            }
        }
