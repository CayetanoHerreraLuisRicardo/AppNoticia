...
{
    public class TuexpertoViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TuexpertoDetail", item);
                        });
                }
        ...
        {
            return new TuexpertoDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TuexpertoList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TuexpertoDetail");
        }
    }
}
