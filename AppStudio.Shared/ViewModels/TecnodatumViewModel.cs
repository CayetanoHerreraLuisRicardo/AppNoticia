...
{
    public class TecnodatumViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TecnodatumDetail", item);
                        });
                }
        ...
        {
            return new TecnodatumDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TecnodatumList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TecnodatumDetail");
        }
    }
}
