...
{
    public class ExcelsiorViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ExcelsiorDetail", item);
                        });
                }
        ...
        {
            return new ExcelsiorDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ExcelsiorList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ExcelsiorDetail");
        }
    }
}
