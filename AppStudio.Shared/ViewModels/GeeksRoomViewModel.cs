...
{
    public class GeeksRoomViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("GeeksRoomDetail", item);
                        });
                }
        ...
        {
            return new GeeksRoomDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("GeeksRoomList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("GeeksRoomDetail");
        }
    }
}
