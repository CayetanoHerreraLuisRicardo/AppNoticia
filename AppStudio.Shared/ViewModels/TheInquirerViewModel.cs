...
{
    public class TheInquirerViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TheInquirerDetail", item);
                        });
                }
        ...
        {
            return new TheInquirerDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TheInquirerList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TheInquirerDetail");
        }
    }
}
