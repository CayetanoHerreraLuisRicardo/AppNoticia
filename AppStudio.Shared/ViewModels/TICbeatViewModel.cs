...
{
    public class TICbeatViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TICbeatDetail", item);
                        });
                }
        ...
        {
            return new TICbeatDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TICbeatList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TICbeatDetail");
        }
    }
}
