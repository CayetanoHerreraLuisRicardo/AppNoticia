...
{
    public class ParentesisViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ParentesisDetail", item);
                        });
                }
        ...
        {
            return new ParentesisDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ParentesisList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ParentesisDetail");
        }
    }
}
