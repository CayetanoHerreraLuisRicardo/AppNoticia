...
{
    public class FayerWayerViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("FayerWayerDetail", item);
                        });
                }
        ...
        {
            return new FayerWayerDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("FayerWayerList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("FayerWayerDetail");
        }
    }
}
