...
{
    public class MilenioViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("MilenioDetail", item);
                        });
                }
        ...
        {
            return new MilenioDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("MilenioList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("MilenioDetail");
        }
    }
}
