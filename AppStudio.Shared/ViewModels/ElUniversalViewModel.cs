...
{
    public class ElUniversalViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ElUniversalDetail", item);
                        });
                }
        ...
        {
            return new ElUniversalDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ElUniversalList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ElUniversalDetail");
        }
    }
}
