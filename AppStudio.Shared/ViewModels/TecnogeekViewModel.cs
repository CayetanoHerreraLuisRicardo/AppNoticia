...
{
    public class TecnogeekViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TecnogeekDetail", item);
                        });
                }
        ...
        {
            return new TecnogeekDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TecnogeekList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TecnogeekDetail");
        }
    }
}
