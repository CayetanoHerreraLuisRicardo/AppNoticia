...
{
    public class NoPuedoCreerViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("NoPuedoCreerDetail", item);
                        });
                }
        ...
        {
            return new NoPuedoCreerDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("NoPuedoCreerList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("NoPuedoCreerDetail");
        }
    }
}
