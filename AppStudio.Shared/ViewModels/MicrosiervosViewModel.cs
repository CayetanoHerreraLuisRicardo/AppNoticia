...
{
    public class MicrosiervosViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("MicrosiervosDetail", item);
                        });
                }
        ...
        {
            return new MicrosiervosDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("MicrosiervosList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("MicrosiervosDetail");
        }
    }
}
