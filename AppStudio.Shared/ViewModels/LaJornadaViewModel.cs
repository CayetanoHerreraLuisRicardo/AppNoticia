...
{
    public class LaJornadaViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("LaJornadaDetail", item);
                        });
                }
        ...
        {
            return new LaJornadaDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("LaJornadaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LaJornadaDetail");
        }
    }
}
