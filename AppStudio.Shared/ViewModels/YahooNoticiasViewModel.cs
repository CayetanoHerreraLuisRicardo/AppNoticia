...
{
    public class YahooNoticiasViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("YahooNoticiasDetail", item);
                        });
                }
        ...
        {
            return new YahooNoticiasDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("YahooNoticiasList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("YahooNoticiasDetail");
        }
    }
}
