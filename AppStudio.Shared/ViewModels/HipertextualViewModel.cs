...
{
    public class HipertextualViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("HipertextualDetail", item);
                        });
                }
        ...
        {
            return new HipertextualDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("HipertextualList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("HipertextualDetail");
        }
    }
}
