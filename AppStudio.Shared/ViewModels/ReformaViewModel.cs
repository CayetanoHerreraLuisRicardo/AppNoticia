...
{
    public class ReformaViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ReformaDetail", item);
                        });
                }
        ...
        {
            return new ReformaDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ReformaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ReformaDetail");
        }
    }
}
