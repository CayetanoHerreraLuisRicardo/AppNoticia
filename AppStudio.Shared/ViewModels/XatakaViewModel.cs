...
{
    public class XatakaViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("XatakaDetail", item);
                        });
                }
        ...
        {
            return new XatakaDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("XatakaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("XatakaDetail");
        }
    }
}
