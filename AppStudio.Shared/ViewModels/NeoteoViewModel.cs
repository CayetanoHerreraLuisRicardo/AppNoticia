...
{
    public class NeoteoViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("NeoteoDetail", item);
                        });
                }
        ...
        {
            return new NeoteoDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("NeoteoList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("NeoteoDetail");
        }
    }
}
