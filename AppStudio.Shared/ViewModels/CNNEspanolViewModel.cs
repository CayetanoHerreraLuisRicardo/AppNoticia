...
{
    public class CNNEspanolViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("CNNEspanolDetail", item);
                        });
                }
        ...
        {
            return new CNNEspanolDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("CNNEspanolList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("CNNEspanolDetail");
        }
    }
}
