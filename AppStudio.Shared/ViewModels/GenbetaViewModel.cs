...
{
    public class GenbetaViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("GenbetaDetail", item);
                        });
                }
        ...
        {
            return new GenbetaDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("GenbetaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("GenbetaDetail");
        }
    }
}
