...
{
    public class InformadorViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("InformadorDetail", item);
                        });
                }
        ...
        {
            return new InformadorDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("InformadorList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("InformadorDetail");
        }
    }
}
